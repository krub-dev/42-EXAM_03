/*
- Funciones auxiliares corregidas. Summary.
  - ft_strchr: Búsqueda de carácter fiable, evitando acceso fuera de límites.
  - ft_memcpy y ft_memmove: Copia de memoria segura y correcta, manejo de solapamientos.
  - ft_strlen: Control de puntero nulo y cálculo preciso de longitud.
  - str_append_mem y str_append_str: Gestión robusta de memoria al concatenar strings.
*/
